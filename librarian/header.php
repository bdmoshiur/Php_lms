...
if (!isset($_SESSION['Librarian_login'])) {
   ...
   $data = mysqli_query($conn, "SELECT * FROM `librarian` WHERE `email`='$Librarian_login'");
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?= ucwords($libraian_info['fastname']).' '.ucwords($libraian_info['lastname']) ; ?></span>
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class=" <?= $page == 'student.php' ? 'active-item' : '' ?> ">
                                    <a href="student.php"><i class="fa fa-users" aria-hidden="true"></i><span>Students</span>
                                    </a>
                                </li>
                            ...
                            <li class="<?= $page == 'issue-book.php' ? 'active-item' : '' ?>">
                                    <a href="issue-book.php"><i class="fa fa-book" aria-hidden="true"></i><span>Issue Book</span></a>
                                </li>
                                <li class="<?= $page == 'return-book.php' ? 'active-item' : '' ?>">
                                    <a href="return-book.php"><i class="fa fa-book" aria-hidden="true"></i><span>Return Book</span></a>
                                </li>
